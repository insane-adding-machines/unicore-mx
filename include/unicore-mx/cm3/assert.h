...
the application linked with unicore-mx defines its own
...
#ifndef UNICOREMX_CM3_ASSERT_H
#define UNICOREMX_CM3_ASSERT_H
 ...
 * is false.
 *
 * The purpose of this macro is to aid in debugging unicore-mx and
