...
#ifndef UNICOREMX_CM3_COMMON_H
#define UNICOREMX_CM3_COMMON_H
...
#		define UNICOREMX_DEPRECATED(x) __attribute__((deprecated(x)))
#	else
#		define UNICOREMX_DEPRECATED(x) __attribute__((deprecated))
#	endif
#else
#	define UNICOREMX_DEPRECATED(x)
#endif
